    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_id', models.IntegerField(blank=True, error_messages={'unique': 'A user with that user_id already exists.'}, null=True, unique=True, verbose_name='社員ID')),
                ('full_name', models.CharField(blank=True, max_length=150, verbose_name='氏名')),
                ('gender', models.CharField(choices=[('1', 'male'), ('2', 'female'), ('3', '-')], default=3, max_length=1, verbose_name='性別')),
